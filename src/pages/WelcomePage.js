    ...
    return (
        ...
        >
            ...
            <div className="w-[120%] h-44 flex bg-light-green -rotate-6 absolute -bottom-20 text-white -left-6 overflow-hidden">
                <div className="w-1/2 h-full bg-dark-green flex items-center justify-center">
                    <CgMail
                        className="mb-20 rotate-6 text-4xl cursor-pointer ml-4"
                        onClick={handleMailClick}
                    />
                </div>
                <div className="w-1/2 h-full bg-light-green flex items-center justify-center">
                    <RiArrowRightDoubleLine
                        className="mt-1 rotate-6 text-5xl cursor-pointer mr-10 mb-10"
